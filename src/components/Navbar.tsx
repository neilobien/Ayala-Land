    ...
    <nav className="fixed top-0 left-0 right-0 z-50 glass-nav">
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <NavLink label="Location" onClick={() => navigate('/location')} />
          <NavLink label="Condominiums" onClick={() => navigate('/category/condominiums')} />
          <NavLink label="Residential Lot" onClick={() => navigate('/category/lot')} />
          <NavLink label="House and Lot" onClick={() => navigate('/category/house-and-lot')} />
        </div>
