        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          <div>
            ...
            <div className="space-y-6">
              <ContactInfo icon={<Mail size={20} />} label="Email Address" value="obienneil.ayalalandintl@gmail.com" />
              <ContactInfo icon={<Phone size={20} />} label="Direct Line" value="+63 9XX XXX XXXX" />
          ...
          >
            <form className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <InputGroup label="Full Name" placeholder="e.g. Juan De La Cruz" />
                <InputGroup label="Email Address" placeholder="e.g. juan@example.com" />
              </div>
              <div className="grid md:grid-cols-2 gap-6">
                <InputGroup label="Preferred Location" placeholder="e.g. Makati, BGC, Nuvali" />
                <InputGroup label="Budget Range (Optional)" placeholder="e.g. 10M - 25M PHP" />
              </div>
              ...
              <button className="w-full bg-brand-dark text-white py-4 rounded-full font-bold uppercase tracking-widest text-xs flex items-center justify-center gap-3 hover:bg-brand-dark/90 transition-all group">
